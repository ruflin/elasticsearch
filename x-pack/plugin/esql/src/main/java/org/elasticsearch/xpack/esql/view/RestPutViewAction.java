...
public class RestPutViewAction extends BaseRestHandler {
    ...
    public static final String VIEW_MANAGED_AND_META = RestGetViewAction.VIEW_MANAGED_AND_META;
    ...
    public Set<String> supportedCapabilities() {
        return Set.of(VIEW_INDEX_ABSTRACTION, VIEWS_PUT_SERVERLESS_SCOPE, VIEW_MANAGED_AND_META);
    }
}
