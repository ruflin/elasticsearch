...
public class ClickHouseDataSourcePlugin extends Plugin implements DataSourcePlugin {
    ...
    static final String TYPE = "clickhouse";
    ...
    public Map<String, StorageProviderFactory> storageProviders(Settings settings) {
        ...
        StorageProviderFactory storageFactory = StorageProviderFactory.noConfigKeys(ClickHouseStorageProvider::new);
        Map<String, StorageProviderFactory> providers = new HashMap<>();
        for (String scheme : SCHEMES) {
            providers.put(scheme, storageFactory);
        }
    ...
    public Map<String, ConnectorFactory> connectors(Settings settings) {
        ...
        // Register via connectors() so DataSourceModule's LazyConnectorFactory can load the
        // factory without a core SPI change. sourceFactories() is the longer-term home, but
        // LazyConnectorFactory still resolves the delegate from connectors() on this branch.
