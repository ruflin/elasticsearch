...
public class ClickHouseConnectorFactoryTests extends ESTestCase {
    ...
    public void testValidateConfigRejectsPasswordWithLineBreaks() {
        expectThrows(
            ValidationException.class,
            () -> factory.validateConfig("clickhouse://host:8123/db/tbl", Map.of("password", "bad\nvalue"))
        );
    }
    ...
    public void testSplitProviderIsNotTheEmptyDefault() {
        // SplitProvider.SINGLE emits no splits, which would make STATS COUNT(*) return zero rows.
        assertNotSame(SplitProvider.SINGLE, factory.splitProvider());
    }
}
